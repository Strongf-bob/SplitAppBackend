...
def ensure_indexes(db: Database) -> None:
    ...
    db.friend_invites.create_index("id", unique=True)
    db.friend_invites.create_index("token_hash", unique=True)
    db.friend_invites.create_index([("creator_id", 1), ("status", 1)])
    db.friend_invites.create_index("expires_at", expireAfterSeconds=0)
