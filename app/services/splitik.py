...
- Используй только поддерживаемый в чате Markdown: короткие абзацы, списки через
  "- " и выделение **жирным**.
- Не используй заголовки, нумерованные списки, таблицы, ссылки, HTML или блоки кода:
  чат их не форматирует.
