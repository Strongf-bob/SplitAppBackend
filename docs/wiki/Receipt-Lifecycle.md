...
stateDiagram-v2
  ...
  collecting_shares --> ready_for_review: позиции готовы
  ready_for_review --> pending_confirmation: завершить распределение
...
```
<!-- Sources: app/services/receipts.py:572-678, app/services/receipts.py:792-970 -->
...
| `ready_for_review` | Создатель/плательщик отметил готовность | Сессия становится `ready` | [ready](https://github.com/Strongf-bob/SplitAppBackend/blob/main/app/services/receipts.py#L914-L935) |
