...
description: "Реальная модель OAuth, JWT, авторизации и защиты операционных интерфейсов."
---
...
| Артефакт | Состав / срок | Где проверяется | Source |
|---|---|---|---|
...
| Page | Relationship |
|---|---|
| [Архитектура](Architecture.md#доверительные-границы) | Карта доверительных границ. |
| [Модель данных](Data-Model.md#коллекции-и-владение) | Показывает ownership и TTL collections. |
| [Операции и деплой](Operations-And-Deployment.md#runtime-и-наблюдаемость) | Описывает хранение runtime secrets и закрытые metrics. |
| [Тесты и CI](Testing-And-CI.md#регрессионные-контракты) | Фиксирует security regression expectations. |
