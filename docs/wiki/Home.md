...
- [Обзор проекта](Project-Overview) — границы ответственности серверной части и состав системы.
...
- [Интеграция с iOS](iOS-Frontend-Integration) — правила использования контракта серверной части клиентом.
