...
description: "Практические правила вызова HTTP API SplitAppBackend: аутентификация, ошибки, пагинация и идемпотентность."
---
...
[Пути пользователя](User-Journey) и [Деньгах и взаиморасчётах](Money-And-Settlement).
...
- [Интеграция SplitApp](SplitApp-Integration)
