...
description: "Пользовательская ценность, границы и ключевые сценарии SplitApp."
---
...
| Кредитор и должник | Ведут заявку на перевод; получатель подтверждает или отклоняет факт оплаты | Заявку создаёт только кредитор, «оплачено» отмечает только должник, подтверждает или отклоняет только получатель | [правила заявки](https://github.com/Strongf-bob/SplitAppBackend/blob/main/app/services/payments.py#L304-L362), [отметка оплаты](https://github.com/Strongf-bob/SplitAppBackend/blob/main/app/services/payments.py#L514-L557) |
