...
2. Обновите релевантную страницу и входящие ссылки. Если меняется API behavior, в том же изменении должны быть schemas, runtime OpenAPI, `openapi.yaml`, regression tests и документация. [API guide](API-Guide#изменение-контракта)
